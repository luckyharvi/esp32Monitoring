...
<script>
  ...
  const host = "ws://192.168.1.12:8080"; // IP localbroker mosquitto and the port WebSocket. Before that, don't forget configure the mosquitto config file

  const option = {
    keepalive: 30,
    clientId: clientId,
    username: "", //input the username if set
    password: "", //input the password if set
    protocolId: "MQTT",
    protocolVersion: 4,
